...
export type ModuleFactory<State extends StateRecord = {}, Actions = {}, Methods = {}, Computed = {}, ExcludedField extends string = never> = {
  ...
  methods<M extends MethodBuilder<State, Actions, Methods>>(builder: M): Omit<ModuleFactory<State, Actions, ReturnType<M> & Methods, Computed, ExcludedField>, ExcludedField>;
